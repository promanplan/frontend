...
export default function AnimatedBeamDemo() {
  ...
  const docHubRef = useRef<HTMLDivElement>(null);
  const requirementsRef = useRef<HTMLDivElement>(null);
  const architectureRef = useRef<HTMLDivElement>(null);
  const apiDesignRef = useRef<HTMLDivElement>(null);
  ...
  return (
    <div
      ...
      ref={containerRef}
    >
      <div className="flex size-full max-h-[450px] max-w-5xl flex-col items-center justify-between gap-8">
        {/* Top row - User */}
        <div className="flex flex-row items-center justify-center">
          <Circle ref={userRef} className="size-16 bg-blue-50">
            <div className="text-2xl">🧑</div>
          </Circle>
        </div>

        {/* Second row - Documentation Agents */}
        <div className="flex flex-row items-center justify-between w-full max-w-2xl">
          <Circle ref={requirementsRef} className="bg-purple-50">
            <div className="text-xl">🎨</div>
          </Circle>
          <Circle ref={architectureRef} className="bg-purple-50">
            <div className="text-xl">📊</div>
          </Circle>
          <Circle ref={apiDesignRef} className="bg-purple-50">
            <div className="text-xl">🏗️</div>
          </Circle>
        </div>

        {/* Middle row - Documentation Hub */}
        <div className="flex flex-row items-center justify-center">
          <Circle ref={docHubRef} className="size-20 bg-yellow-50">
            <div className="text-2xl">📄</div>
          </Circle>
        </div>

        {/* Bottom row - Implementation Agents */}
        <div className="flex flex-row items-center justify-between w-full max-w-3xl">
          <Circle ref={frontendRef} className="bg-green-50">
            <div className="text-xl">💻</div>
          </Circle>
          <Circle ref={backendRef} className="bg-green-50">
            <div className="text-xl">🛠️</div>
          </Circle>
          <Circle ref={devopsRef} className="bg-green-50">
            <div className="text-xl">⚙️</div>
          </Circle>
          <Circle ref={securityRef} className="bg-green-50">
            <div className="text-xl">🔐</div>
          </Circle>
        </div>
      </div>

      {/* User to Documentation Hub */}
      <AnimatedBeam
      ...
      {/* Documentation Agents to Documentation Hub */}
      <AnimatedBeam
        containerRef={containerRef}
        fromRef={requirementsRef}
        toRef={docHubRef}
        curvature={-30}
      />
      <AnimatedBeam
      ...
      <AnimatedBeam
        containerRef={containerRef}
        fromRef={apiDesignRef}
        toRef={docHubRef}
        curvature={30}
      />

      {/* Documentation Hub to Implementation Agents */}
      <AnimatedBeam
        containerRef={containerRef}
        fromRef={docHubRef}
        toRef={frontendRef}
